...
-- Le damos los permisos de lectura al desarrollador para que pueda consultar
GRANT SELECT ON ANTECEDENTES_LABORALES TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON ANTECEDENTES_PERSONALES TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON INSTITUCION TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON PAIS TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON PASANTIA_PERFECCIONAMIENTO TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON POSTULACION_PASANTIA_PERFEC TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON PTJE_ANNOS_EXPERIENCIA TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON PTJE_PAIS_POSTULA TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON PTJE_PUEBLO_INDIGENA TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON PUEBLO_INDIGENA TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON REGION TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON SERVICIO_LOCAL_EDUCP TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON DETALLE_PUNTAJE_POSTULACION TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT SELECT ON RESULTADO_POSTULACION TO BDY1102_ET_FA_DES_MACEVEDO;

-- Permisos de escritura para que el desarrollador pueda llenar las tablas de resultados
GRANT INSERT, UPDATE, DELETE ON DETALLE_PUNTAJE_POSTULACION TO BDY1102_ET_FA_DES_MACEVEDO;
GRANT INSERT, UPDATE, DELETE ON RESULTADO_POSTULACION TO BDY1102_ET_FA_DES_MACEVEDO;

-- Creamos el indice para optimizar el informe de revision (Req 4.2)
CREATE INDEX IDX_PTJE_FINAL ON RESULTADO_POSTULACION(ptje_final_post);