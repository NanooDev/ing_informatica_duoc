-- CONECTADO COMO MACEVEDO_ADM
-- CREACION DE TABLAS Y POBLACION
...
insert into cliente values ('13685017-1','JOHNNY YA EZ','PROVIDENCIA 2900',NULL,78598619,'A','JYANEZ@GMAIL.COM',1200000,200000);
...
insert into VENDEDOR values (4,'10456789-4','LUIS MU OZ','ALAMEDA 960',4,96888222,'LMUNOZ@GMAIL.COM',270000,0.4,to_date('07-09-2011'),50);
...
INSERT INTO TRAMO_ESCOLARIDAD VALUES(10,'BA','B SICA',1);
INSERT INTO TRAMO_ESCOLARIDAD VALUES(20,'MCH','MEDIA CIENT FICA HUMANISTA',2);
INSERT INTO TRAMO_ESCOLARIDAD VALUES(30,'MTP','MEDIA T CNICO PROFESIONAL',3);
INSERT INTO TRAMO_ESCOLARIDAD VALUES(40,'SCFT','SUPERIOR CENTRO DE FORMACI N T CNICA',4);
...
-- REQUERIMIENTO 0 - FINAL (Accesos a Datos)

-- 1. Privilegios de CONSULTA (SELECT) para MACEVEDO_REPORT
-- Segun las tablas: CLIENTE, DETALLE_BOLETA, DETALLE_FACTURA, DETALLE_VENTA y FACTURA
GRANT SELECT ON CLIENTE TO MACEVEDO_REPORT;
GRANT SELECT ON DETALLE_BOLETA TO MACEVEDO_REPORT;
GRANT SELECT ON DETALLE_FACTURA TO MACEVEDO_REPORT;
GRANT SELECT ON DETALLE_VENTA TO MACEVEDO_REPORT;
GRANT SELECT ON FACTURA TO MACEVEDO_REPORT;

-- 2. Privilegios de DML (INSERT, UPDATE, DELETE) para MACEVEDO_REPORT
-- Segun las tablas: PRODUCTO_HISTORICO, RESUMEN_POR_CLIENTE, RESUMEN_POR_PRODUCTO, UNIDAD_MEDIDA
GRANT INSERT, UPDATE, DELETE ON PRODUCTO_HISTORICO TO MACEVEDO_REPORT;
GRANT INSERT, UPDATE, DELETE ON RESUMEN_POR_CLIENTE TO MACEVEDO_REPORT;
GRANT INSERT, UPDATE, DELETE ON RESUMEN_POR_PRODUCTO TO MACEVEDO_REPORT;
GRANT INSERT, UPDATE, DELETE ON UNIDAD_MEDIDA TO MACEVEDO_REPORT;

-- 3. Privilegios para MACEVEDO_EXTERNO
-- El documento solo menciona consultar informacion asi que le damos SELECT en las tablas base
GRANT SELECT ON CLIENTE TO MACEVEDO_EXTERNO;
GRANT SELECT ON PRODUCTO TO MACEVEDO_EXTERNO;
GRANT SELECT ON BOLETA TO MACEVEDO_EXTERNO;
